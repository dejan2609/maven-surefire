     ...
     implements StreamConsumer
{
            ...
            implements ForkedProcessReportEventListener<TestSetReportEntry>
    {
        ...
        public void handle( RunMode runMode, TestSetReportEntry reportEntry )
        {
            ...
            TestSetReportEntry entry = new SimpleReportEntry( reportEntry.getSourceName(), reportEntry.getName(),
                    reportEntry.getStackTraceWriter(), reportEntry.getElapsed(), getTestVmSystemProperties() );
